...
#define STRING_VERSION_CONFIG_H "2013-03-08" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "VELLEMAN - GELOEN" //Who made the changes.
